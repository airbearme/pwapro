...
declare -a env_vars=(
    ...
    "NEXT_PUBLIC_SUPABASE_PWA4_ANON_KEY=${SUPABASE_SERVICE_ROLE_KEY:-[REQUIRED]}"
    "SUPABASE_PWA4_SERVICE_ROLE_KEY=${SUPABASE_SERVICE_ROLE_KEY:-[REQUIRED]}"
    ...
    "VITE_SUPABASE_ANON_KEY=${SUPABASE_SERVICE_ROLE_KEY:-[REQUIRED]}"
