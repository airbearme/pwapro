...
const AirbearWheel = memo(
  ({
    ...
    const glowClass = glowing ? "shadow-lg shadow-emerald-500/50 animate-pulse-glow" : ""
    const spinClass = animated ? "animate-wheel-spin" : ""

    return (
      <div className={cn("airbear-wheel relative", sizeClasses[size], glowClass, className)}>
        <div
          className={cn(
