          ...
          <TabsContent value="stripe" className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                aria-label={walletLoading.apple ? "Processing Apple Pay" : "Pay with Apple Pay"}
              >
                <div className="text-center">
                  {walletLoading.apple ? (
                    <Spinner className="size-6 mx-auto mb-1" />
                  ) : (
              ...
              <Button
                ...
                aria-label={walletLoading.google ? "Processing Google Pay" : "Pay with Google Pay"}
              >
                <div className="text-center">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full"
              aria-label={loading ? "Processing checkout" : "Pay with Credit Card"}
            >
              {loading ? (
                <>
          ...
          <TabsContent value="cash" className="space-y-4">
            <div className="text-center p-6 border rounded-lg bg-muted/50">
              ...
              <Button
                ...
                aria-label={isCashPaymentLoading ? "Processing cash payment" : "Continue with Cash Payment"}
              >
