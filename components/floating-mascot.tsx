    ...
    <Tooltip delayDuration={300}>
      <TooltipTrigger asChild>
        <Link
          ...
          className="fixed bottom-6 right-6 z-50 transition-all duration-500 opacity-100 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 outline-none rounded-full"
          style={{
            transform: (followX === 0 && followY === 0) ? undefined : `translate(${followX}px, ${followY}px)`,
          }}
        >
      ...
      <TooltipContent side="top" align="end" className="bg-emerald-600 dark:bg-emerald-700 text-white font-semibold border-none">
        Go Home 🏠
      </TooltipContent>
    </Tooltip>
  );
