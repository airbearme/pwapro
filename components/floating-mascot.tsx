    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          ...
          className="fixed bottom-6 right-6 z-50 w-16 h-16 md:w-20 md:h-20 transition-all duration-500 opacity-100 translate-y-0 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-none rounded-full"
          style={{
