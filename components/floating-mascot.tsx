    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          ...
          className="fixed bottom-6 right-6 z-50 transition-all duration-500 opacity-100 translate-y-0 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:outline-none rounded-full"
          style={{
