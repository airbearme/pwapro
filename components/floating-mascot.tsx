    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          ...
          className="fixed bottom-6 right-6 z-50 transition-all duration-500 opacity-100 translate-y-0 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-500/50 rounded-full"
          style={{
