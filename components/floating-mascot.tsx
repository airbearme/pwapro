    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Link
          ...
          className="fixed bottom-6 right-6 z-50 transition-all duration-500 opacity-100 translate-y-0 rounded-full focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 outline-none"
          style={{
      ...
      <TooltipContent
        side="left"
        className="bg-emerald-600 dark:bg-emerald-700 text-white font-semibold border-none shadow-lg"
      >
        Go Home 🏠
      </TooltipContent>
    </Tooltip>
