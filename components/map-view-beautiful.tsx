...
const MapView = memo(({ spots, airbears, onSpotSelect }: MapViewProps) => {
  ...
  useEffect(() => {
    ...
    spots.forEach((spot) => {
      ...
      // ⚡ Bolt: Only update icon if count changed
    ...
    // ⚡ Bolt: Cleanup markers for removed spots
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Cleanup markers for removed airbears
