...
export function getSupabaseAdmin() {
  const supabaseUrl =
    process.env.NEXT_PUBLIC_SUPABASE_PWA4_URL || process.env.NEXT_PUBLIC_SUPABASE_URL
  const supabaseServiceRoleKey =
    process.env.SUPABASE_PWA4_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY
