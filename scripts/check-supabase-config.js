...
console.log(
  `   NEXT_PUBLIC_SUPABASE_PWA4_URL: ${supabaseUrl ? "✅ Set" : "❌ MISSING"}`,
);
console.log(
  `   NEXT_PUBLIC_SUPABASE_PWA4_ANON_KEY: ${supabaseAnonKey ? "✅ Set" : "❌ MISSING"}`,
);
console.log(
  `   SUPABASE_PWA4_SERVICE_ROLE_KEY: ${serviceRoleKey ? "✅ Set" : "❌ MISSING"}`,
);
...
console.log("\n📝 Next steps:");
console.log(
  "1. Verify the Supabase URL matches your project in Supabase Dashboard",
);
console.log(
  "2. Make sure OAuth providers (Google/Apple) are enabled in Supabase",
);
